...
# DIVIDE DATA IN 2 PART (80% create model, 20% validate the model)
...
scoring = "accuracy" # To evalutate models in percentage
...
# KNN is the best accurate since it has the largest estimated accuracy score
